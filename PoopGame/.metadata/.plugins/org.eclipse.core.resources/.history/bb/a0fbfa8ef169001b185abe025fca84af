...
public class KeyUtil {
    ...
    public static String getKeyText(int keyCode) {
    	return getKeyText(keyCode, null);
    }

    public static String getKeyText(int keyCode, Font font) {
        ...
        switch(keyCode) {
          ...
          case KeyEvent.VK_LEFT: return font == null || font.canDisplay('←') ? "←" : "LEFT";
          case KeyEvent.VK_UP: return font == null || font.canDisplay('↑') ? "↑" : "UP";
          case KeyEvent.VK_RIGHT: return font == null || font.canDisplay('→') ? "→" : "RIGHT";
          case KeyEvent.VK_DOWN: return font == null || font.canDisplay('↓') ? "↓" : "DOWN";
