...
public class TitledIconBorder extends AbstractBorder
{
    ...
    /**
     * Added by Arno Rohner
     * @param icon will be painted inside the title
     * @return this for chaining
     */
    public TitledIconBorder setIcon(Icon icon){
    	this.icon = icon;
    	return this;
    }
    ...
    /**
     * Added by Arno Rohner
     * @param textPosition the position of the text inside the title (relevant if an icon is present)
     * @return this for chaining
     */
	public TitledIconBorder setHorizontalTextPosition(int textPosition) {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if (((title != null) && !title.isEmpty()) || getIcon() != null) {
            int edge = (border instanceof TitledIconBorder) ? 0 : EDGE_SPACING;
    ...
    public Component.BaselineResizeBehavior getBaselineResizeBehavior(
        ...
        switch (getPosition()) {
            case TitledIconBorder.ABOVE_TOP:
            case TitledIconBorder.TOP:
            case TitledIconBorder.BELOW_TOP:
                return Component.BaselineResizeBehavior.CONSTANT_ASCENT;
            case TitledIconBorder.ABOVE_BOTTOM:
            case TitledIconBorder.BOTTOM:
            case TitledIconBorder.BELOW_BOTTOM:
